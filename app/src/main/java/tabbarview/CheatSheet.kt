...
object CheatSheet {
     ...
     */
    fun setup(view: View) {
        view.setOnLongClickListener(View.OnLongClickListener { view -> showCheatSheet(view, view.getContentDescription()) })
    }
     ...
     */
 public fun setup(view: View, textResId: Int) {
        view.setOnLongClickListener(View.OnLongClickListener { view -> showCheatSheet(view, view.getContext().getString(textResId)) })
    }
     ...
     */
    public  fun setup(view: View, text: CharSequence) {
        view.setOnLongClickListener(View.OnLongClickListener { view -> showCheatSheet(view, text) })
    }
